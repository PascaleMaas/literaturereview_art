...
columns_methods <- c("method_qualitative","method_quantitative", "method_mixed")
...
columns_locations <- c("location_europe", "location_nordamerica", "location_asia", "location_southamerica", "location_online", "location_australia", "location_europe_secundary")

columns_intergration <- c("artsrelated", "artsbased", "artsinformed")
...
print(datacleaningtable %>% select(methods, disciplines, context, 
                                   objectives, locations, intergration, results), width = Inf)
...
new_cols <- c("methods", "disciplines", "context", 
              "objectives", "locations", "intergration", "results")
...
# Define output path
file_path <- "/Users/Accounttijdelijk/Desktop/datacleaningtable.xlsx"
